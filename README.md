<h1><center>Introducción al uso de la página web de</center></h1>
<center>
...
En concreto, el contenido de este repositorio está enfocado a conocer el funcionamiento de la página web de [SIMANFOR](https://www.simanfor.es).


## Contenido:

*   logos: carpeta con los diferentes logos utilizados en estos documentos explicativos (README.md) del [repositorio github de SIMANFOR](https://github.com/simanfor) 
*   SIMANFOR_web.pdf: tutorial acerca del uso de la página web de SIMANFOR
